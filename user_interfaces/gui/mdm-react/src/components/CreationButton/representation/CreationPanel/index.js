...
const CreationPanel = ({
    ...
    <div className="panel">
        ...
        <ul>
            <li onClick={isSystemActive ? handleMachineCreation : null}
                className={c({"disabled": !isSystemActive})}>
                <i className="material-icons">dns</i> Add machine
            </li>
            <li onClick={isSystemActive ? handleServiceCreation : null}
                className={c({"disabled": !isSystemActive})}>
                <i className="material-icons">category</i> Add service
            </li>
            <li onClick={isSystemActive ? handleConnectionCreation : null}
                className={c({"disabled": !isSystemActive})}>
                <i className="material-icons">swap_horiz</i> Add connection
            </li>
        </ul>
    </div>
);
